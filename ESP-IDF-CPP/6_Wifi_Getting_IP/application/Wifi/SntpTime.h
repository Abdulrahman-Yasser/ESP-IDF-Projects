...
public:
    Sntp(Sntp &other) = delete;
    void operator=(const Sntp &) = delete;
    static Sntp& get_instance(void)
    {
        ESP_LOGD(_log_tag, "Got an instance of sntp" ); // TODO remove extra newline
        return my_singleton_sntp;
    }
